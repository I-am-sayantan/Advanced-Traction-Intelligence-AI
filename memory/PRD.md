...
- **Backend**: Express (Node.js/TypeScript) on port 8000
- **Frontend**: React + TypeScript + Tailwind CSS on port 3000
...
- [x] Landing page with email/password login/signup
- [x] Auth with session management (httpOnly cookies, bcrypt password hashing)
